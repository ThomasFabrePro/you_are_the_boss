...
class FirstEpisode extends Episode {
  FirstEpisode()
    ...
    C'est le tout premier jour, les murs de votre bureau, encore vierges de toute décoration, résonnent de promesses et d'opportunités. Vous caressez doucement la peinture fraîche en vous disant « Yesss voilà la plus grande aventure de ma vie... J'ai hâte ! » Vous pouvez presque sentir l'excitation palpable dans l'air, l'énergie bouillonnante qui émane de chaque membre de votre équipe, prêt à transformer cette vision en réalité.
